...
DATABASES = {
    "default": {
        ...
        "NAME": "drivers",                       # Or path to database file if using sqlite3.
        "USER": "benji",                             # Not used with sqlite3.
...
MEDIA_REGISTER = "/site_media/register/"
...
SECRET_KEY = "za_x+-e8gzur9#k5el(+^=e(uolg-ijeink*%)f(37bj432#!!"
...
TEMPLATE_DIRS = [
    ...
    os.path.join(PROJECT_ROOT, "templates/staff"),
]
...
LOGIN_REDIRECT_URLNAME = "staff" #"welcome" #"what_next"
